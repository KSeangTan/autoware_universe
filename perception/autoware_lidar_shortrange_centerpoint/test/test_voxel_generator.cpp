...
TEST_F(VoxelGeneratorTest, SingleFrame)
{
  ...
  autoware::lidar_shortrange_centerpoint::DensificationParam param(world_frame_, num_past_frames);

  autoware::lidar_shortrange_centerpoint::CenterPointConfig config(
  ...
  autoware::lidar_shortrange_centerpoint::VoxelGenerator voxel_generator(param, config);
