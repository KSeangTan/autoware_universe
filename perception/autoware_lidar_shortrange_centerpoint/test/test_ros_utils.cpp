...
TEST(TestSuite, box3DToDetectedObject)
{
  ...
  {
    autoware::lidar_shortrange_centerpoint::Box3D box3d;
    box3d.score = 0.8f;
    box3d.label = 0;  // CAR
    box3d.x = 1.0;
    box3d.y = 2.0;
    ...
    autoware::lidar_shortrange_centerpoint::box3DToDetectedObject(box3d, class_names, true, true, obj);
  ...
  // Test case 2: Test with invalid label, has_twist=false, has_variance=false
  {
    ...
    autoware_perception_msgs::msg::DetectedObject obj;
    autoware::lidar_shortrange_centerpoint::box3DToDetectedObject(box3d, class_names, false, false, obj);
...
{
  EXPECT_EQ(
    autoware::lidar_shortrange_centerpoint::getSemanticType("CAR"),
    autoware_perception_msgs::msg::ObjectClassification::CAR);
  EXPECT_EQ(
    autoware::lidar_shortrange_centerpoint::getSemanticType("TRUCK"),
    autoware_perception_msgs::msg::ObjectClassification::TRUCK);
  EXPECT_EQ(
    autoware::lidar_shortrange_centerpoint::getSemanticType("BUS"),
    autoware_perception_msgs::msg::ObjectClassification::BUS);
  EXPECT_EQ(
    autoware::lidar_shortrange_centerpoint::getSemanticType("TRAILER"),
    autoware_perception_msgs::msg::ObjectClassification::TRAILER);
  EXPECT_EQ(
    autoware::lidar_shortrange_centerpoint::getSemanticType("BICYCLE"),
    autoware_perception_msgs::msg::ObjectClassification::BICYCLE);
  EXPECT_EQ(
    autoware::lidar_shortrange_centerpoint::getSemanticType("MOTORBIKE"),
    autoware_perception_msgs::msg::ObjectClassification::MOTORCYCLE);
  EXPECT_EQ(
    autoware::lidar_shortrange_centerpoint::getSemanticType("PEDESTRIAN"),
    autoware_perception_msgs::msg::ObjectClassification::PEDESTRIAN);
  EXPECT_EQ(
    autoware::lidar_shortrange_centerpoint::getSemanticType("UNKNOWN"),
...
TEST(TestSuite, convertPoseCovarianceMatrix)
{
  ...
  std::array<double, 36> pose_covariance =
    autoware::lidar_shortrange_centerpoint::convertPoseCovarianceMatrix(box3d);
...
TEST(TestSuite, convertTwistCovarianceMatrix)
{
  ...
  std::array<double, 36> twist_covariance =
    autoware::lidar_shortrange_centerpoint::convertTwistCovarianceMatrix(box3d, yaw);
