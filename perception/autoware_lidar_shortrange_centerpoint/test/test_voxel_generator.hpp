...
public:
  ...
  std::unique_ptr<autoware::lidar_shortrange_centerpoint::DensificationParam> densification_param_ptr_{};
  std::unique_ptr<autoware::lidar_shortrange_centerpoint::CenterPointConfig> config_ptr_{};
