...
{
  autoware::lidar_shortrange_centerpoint::NonMaximumSuppression nms;
  autoware::lidar_shortrange_centerpoint::NMSParams params;
  params.search_distance_2d_ = 1.0;
  params.iou_threshold_ = 0.2;
  nms.setParameters(params);

  std::vector<autoware::lidar_shortrange_centerpoint::DetectedObject> input_objects(4);
  ...
  std::vector<autoware::lidar_shortrange_centerpoint::DetectedObject> output_objects =
